export function CronExpressionInputTemplateGenerator(obj, objLang) {
    return `
<div class="cronInput" style="display: flex; width: ${obj.width}; height: ${obj.height};">
    <input class="cronInsideInput" type="text" class="form-control" placeholder="${objLang.inputPlaceholder}" name="${obj.name}">
        ...
        <div class="modal-content" style="height: 500px">
            <div class="modal-header" style="height: 0px; padding-bottom: 30px;">
                ...
                <span class="close2 cronSave" style="margin-right: 10px;">
                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check-circle" fill="${obj.colorMain}" style=" font-size: 21px;">
                        <path fill-rule="evenodd" d="M8 15A7 7 0 1 0 8 1a7 7 0 0 0 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
